...
<?php endif; ?>
				...
				<section class="page-actions">
					...
					<div class="modal share-modal animated fadeIn">
						<a class="shortlink" href="http://<?php echo str_replace(stripos($_SERVER['SERVER_PROTOCOL'],'https') === true ? 'https://' : 'http://', '', wp_get_shortlink()); ?>"><?php echo str_replace('/', '/&#8203;', str_replace(stripos($_SERVER['SERVER_PROTOCOL'],'https') === true ? 'https://' : 'http://', '', wp_get_shortlink())); ?></a>
